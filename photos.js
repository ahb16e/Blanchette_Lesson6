...
function previewFive() {
 ...
 var lastFigure = document.createElement("figure");
    ...
    //add or attach the fifth image to preview
     ...
     // THis code below will add source paths to NEW photos. It assigns the order to 0 and 4
...
function createEventListeners() {
    ...
    // declare varible for document element with id of leftarrow
    // then use getElementById() to specify varible as the document element with the id value leftarrow
    
   var leftarrow = document.getElementById("leftarrow");
       leftarrow.addEventListener("click", leftArrow, false);
       
       
    //declare variable for document element w/h id of "rightarrow"
   var rightarrow = document.getElementById("rightarrow");

    //add an event listener to doc element "rightarrow"
